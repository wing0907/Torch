...
path = './_data/torch/'
train_dataset = FashionMNIST(path, train=True, download=True, transform=transf) #.to(DEVICE)
test_dataset = FashionMNIST(path, train=False, download=True, transform=transf)  #.to(DEVICE)
