...
path = './_data/torch/'
train_dataset = FashionMNIST(path, train=True, download=True) #.to(DEVICE)
test_dataset = FashionMNIST(path, train=False, download=True)  #.to(DEVICE)
...
print(train_dataset[59999])     # (<PIL.Image.Image image mode=L size=28x28 at 0x11C7FEC1DB0>, 5)
...
# Final Loss: 0.49852513200558796
# Final ACC: 0.8263778