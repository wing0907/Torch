...
print(train_set)     # <torch.utils.data.dataset.TensorDataset object at 0x000002C30B7E9C00>
print(type(train_set)) # <class 'torch.utils.data.dataset.TensorDataset'>
print(len(train_set)) # 105
print(train_set[0])
# (tensor([-1.5613,  0.7235, -1.3531, -1.1863], device='cuda:0'), tensor([0.], device='cuda:0'))
print(train_set[0][0])      # 첫번째 x
# tensor([-1.5613,  0.7235, -1.3531, -1.1863], device='cuda:0')
...
# Final Loss: 0.11859947140328586
